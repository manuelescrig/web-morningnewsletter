            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    foreach ($plans as $planKey => $plan): ?>
                        <div class="border rounded-lg p-4 <?php echo isset($plan['popular']) ? 'border-blue-500 bg-blue-50' : 'border-gray-200'; ?>">
                            <?php if (isset($plan['popular'])): ?>
                                <div class="text-center mb-2">
                                    <span class="inline-flex px-3 py-1 rounded-full text-xs font-semibold bg-blue-500 text-white">
                                        Most Popular
                                    </span>
                                </div>
                            <?php endif; ?>
