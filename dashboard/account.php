...
<body class="bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 py-8">
        ...
        <!-- Alert Messages -->
        <?php if ($error): ?>
        <div class="mb-6 bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-md" data-notification="error" style="display: none;">
        ...
        <?php if ($success): ?>
        <div class="mb-6 bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-md" data-notification="success" style="display: none;">
