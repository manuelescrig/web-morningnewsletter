    ...
    public function getData(): array {
        try {
            ...
            if ($showHoldings && $holdingsAmount > 0) {
                ...
                // Format holdings amount (show up to 8 decimal places for BNB)
                ...
                $result[] = [
                    'label' => "Holdings ({$formattedAmount} BNB)",
    ...
    public function getConfigFields(): array {
        return [
            [
                ...
                'required' => false,
                'description' => 'Display the value of your BNB holdings'
            ],
            [
                ...
                'required' => false,
                'placeholder' => '0.5',
                'description' => 'Amount of BNB you hold (e.g., 0.5, 1.25, 100)',
                'step' => '0.00000001',
                'min' => '0'
            ]
        ];
