...
class NewsletterBuilder {
    ...
    private function getWeatherSvgIcon($iconClass) {
        // For Gmail compatibility, we'll skip the icon entirely and just show the weather
        // Gmail doesn't support inline SVGs or many CSS properties
        return '';
    }
    
    private function getWeatherColumnIcon($iconClass) {
        // For Gmail compatibility, return empty string - no icons
        return '';
    }
